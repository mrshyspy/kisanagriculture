  ...
  return (
    <div className="container mx-auto py-9 md:py-12 px-6 md:px-6">
      <div className="flex flex-col md:flex-row items-stretch justify-center space-y-4 md:space-y-0 md:space-x-6 lg:space-x-8">
        <div className="flex flex-col md:flex-row items-center justify-between bg-gray-100 dark:container mx-auto p-6 bg-gradient-to-br from-green-600 to-green-500 py-6 px-6 md:py-12 lg:px-12 md:w-8/12 lg:w-7/12 xl:w-8/12 2xl:w-9/12 rounded-lg shadow-lg">
