          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <div
              ...
              <svg
                ...
                aria-hidden="true">
                <defs>
                  <pattern id="pattern-id" width="200" height="200" x="100%" y="-1"
                ...
                <rect width="100%" height="100%" strokeWidth="0" fill="url(#pattern-id)"></rect>
              </svg>
            </div>
        ...
        <form className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-32">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div className="mt-8 flex justify-end">
              <button
                type="submit"
                className="w-max rounded-2xl border-2 border-green-600 bg-green-600 px-5 py-1.5 text-sm font-semibold text-white transition-colors duration-150 ease-in-out hover:border-green-700 hover:bg-green-700"
              >
                Send message
              </button>
            </div>
