    ...
    <footer className="bg-green-600 text-white py-8">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-8">
            <div className="footer-widget flex flex-col items-start">
              <a href="https://www.jangeer.com" className="mb-4">
                <img
                  src="/img/89/1696827795logo.png?h=100"
                  width="100"
                  height="100"
                  alt="Jangeer Manufacturing Industries Pvt. Ltd."
          ...
          <div className="w-full sm:w-1/2 md:w-1/4 px-4 mb-8">
            <div className="footer-widget">
              ...
              <div className="space-y-3">
                ...
                <p className="flex items-center text-white text-sm"><FaEnvelope className="mr-3" /><a href="mailto:jangeerthreshar@gmail.com" className="hover:text-gray-300 hover:underline transition">jangeerthreshar@gmail.com</a></p>
              </div>
            </div>
          </div>
        ...
        <div className="text-center mt-8 text-gray-200 text-sm">
          <p>&copy; {new Date().getFullYear()} Jangeer Manufacturing Industries Pvt. Ltd. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
