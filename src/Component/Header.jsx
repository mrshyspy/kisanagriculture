...
const Header = () => {
  return (
    <header className="bg-white shadow-lg p-2 sm:p-0">
      <div className="flex items-center justify-between flex-wrap sm:flex-nowrap">
        ...
        <div className="flex items-center mt-2 sm:mt-0">
          <a
            className="group flex items-center justify-center ring-none rounded-lg shadow-lg font-semibold 
            py-1 px-3 sm:py-2 sm:px-4 text-xs sm:text-sm bg-gray-100 border-b-4 border-b-green-600 mr-6 sm:mr-10"
            href="tel:9828719163"
          >
