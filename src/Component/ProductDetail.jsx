    ...
    <div className="flex flex-col lg:flex-row lg:space-x-12 bg-gray-50 p-4 md:p-6 shadow-md">
      ...
      <div className="lg:w-1/2 flex flex-col justify-center space-y-4 md:space-y-6 mt-4 lg:mt-0">
        ...
        <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
          <button className="bg-green-600 hover:bg-green-600 text-white px-4 py-2 md:px-6 md:py-3 rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105">
            Get On Road Price
          </button>
