      ...
      <div className="container mx-auto p-6 bg-white text-gray-800">
        ...
        <div className="flex flex-col lg:flex-row lg:space-x-12 bg-gray-50 p-4 md:p-6 shadow-md">
          ...
          <div className="lg:w-1/2 flex flex-col justify-center space-y-4 md:space-y-6 mt-4 lg:mt-0">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-800">{thresher.ModelName}</h1>
            <p className="text-gray-700 leading-relaxed">{thresher.details.description}</p>
