...
export function GreenModernButtonInline() {
  return (
    <Button
      className="group relative overflow-hidden bg-white text-green-600 border border-gray-300 px-4 py-2 rounded-full text-base font-normal transition-all duration-300 ease-out hover:text-white hover:shadow-md">
